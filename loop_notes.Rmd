...
2. In the `nhtemp`, write a loop to add up the temperatures *for all of the even numbered years*, the divide by the total number of even numbered years to get the average.
